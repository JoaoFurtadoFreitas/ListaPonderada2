...
Classe Carro herda de Veiculo:
    ...
    Método Construtor(modelo, ano, consumoPorKm):
...
Inicio
    Definir velocidadeInicial, desaceleracao, velocidadeSegura, tempoMaximo
    tempo <- 0
    ...
    Se velocidade <= velocidadeSegura então
        Escrever("A sonda atingiu uma velocidade segura para pouso em", tempo, "segundos.")
    Senão
        Escrever("Tempo máximo atingido! Risco de desvio orbital.")
Fim
```
______
...
# Exemplo de uso da função  
investimentosAno1 <- [[1000, 2000], [1500, 2500]]  
investimentosAno2 <- [[1.1, 0.9], [0.8, 1.2]]  

impactoInvestimentos <- MultiplicarMatrizesInvestimento(investimentosAno1, investimentosAno2)  
